...
namespace kroniiapi.Services
{
    public class CompanyService : ICompanyService
    {
        ...
        {
            return await _dataContext.Companies.Where(c => c.CompanyId == id).FirstOrDefaultAsync();
        }
        ...
        {
            return await _dataContext.Companies.Where(c => c.Username.Equals(username)).FirstOrDefaultAsync();
        }
        ...
        {
            return await _dataContext.Companies.Where(c => c.Email.Equals(email)).FirstOrDefaultAsync();
        }
        ...
        {
            var existedCompany = await _dataContext.Companies.Where(c => c.CompanyId == id).FirstOrDefaultAsync();
            ...
            existedCompany.CreatedAt = company.CreatedAt;
